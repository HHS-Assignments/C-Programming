# Opgave 3: Compile proces
a) Op BrightSpace staat een simpel_vierkant.c file die gebruik maakt van freeglut. Run deze
code in Visual Studio. Maak gebruik van een al compiled package met de dll, lib en header
